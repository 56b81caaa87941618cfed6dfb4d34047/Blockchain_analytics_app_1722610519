...
Vue.component("simple_header_component_1722610522", {
    template: `
`
<header id="header-section" class="w-full bg-opacity-20 backdrop-blur-lg rounded-lg backdrop-filter">
    <nav id="nav-bar" class="bg-white bg-opacity-20 py-2.5 dark:bg-gray-900 backdrop-blur-lg rounded-lg backdrop-filter">
        <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            <a id="logo-link" href="#" class="flex items-center">
                ...
                <span id="app-name" class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">BlockChain Insights</span>
            </a>
